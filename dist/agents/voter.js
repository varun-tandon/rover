 ...
 */
export async function runVoter(options) {
        ...
        try {
            ...
            if (resultText) {
                try {
                    ...
                    if (jsonMatch) {
                        const parsedVoteResponse = JSON.parse(jsonMatch[0]);
 ...
 * );
 */
export async function runVotersInParallel(targetPath, agentId, issues, voterCount = 3, onProgress) {
